...
public class LongestPalindromBasicWay {
    ...
    *
    * when i =0 the j=i ie j=0   Hence we cover from dead left to dead right
    * when i=2 the j=i  so j=2   here we cover from 2nd index to dead end
    * in this way actually cover all the window in brute force
    *
    * In short we check with ever start and consider every end
    *
    *
    * */
